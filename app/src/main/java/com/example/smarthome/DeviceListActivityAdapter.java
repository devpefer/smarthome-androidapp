...
public class DeviceListActivityAdapter extends RecyclerView.Adapter<DeviceListActivityAdapter.ViewHolderDatos>  {
    ...
    public static class ViewHolderDatos extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            else if (arrayAires.get(getAdapterPosition()) instanceof Sonoff) {
                if (v.getId() == R.id.lytRecyclerPlano) {
            ...
            else if (arrayAires.get(getAdapterPosition()) instanceof RPi) {
                if (v.getId() == R.id.lytRecyclerPlano) {
    ...
    public DeviceListActivityAdapter(Context context, ArrayList<MQTTDevice> misSitios) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
        ...
        if (misSitios.get(position) instanceof AireAcondicionado) {
            ...
            if (misSitios.get(position).getPow().equals("OFF")) {

                estado = "Estado: Apagado";

            } else if (misSitios.get(position).getPow().equals("ON")) {
