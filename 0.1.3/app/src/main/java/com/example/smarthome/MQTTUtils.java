    ...
    public MQTTUtils(final Context context, String serverURI, String clientId) {
        ...
        private void procesarMensaje (String topic, MqttMessage message){
            ...
            if (topic.equals("ewpe-smart/" + mac + "/status")) {
                ...
                for (int i = 0; i < PlanoActivity.getDevices().size(); i++) {

                    if (PlanoActivity.getDevices().get(i).getMac().equals(aircoParamsTemp.getMac())) {

                        PlanoActivity.getDevices().get(i).setAir(aircoParamsTemp.getAir());
                        PlanoActivity.getDevices().get(i).setBlo(aircoParamsTemp.getBlo());
                        PlanoActivity.getDevices().get(i).setHealth(aircoParamsTemp.getHealth());
                        PlanoActivity.getDevices().get(i).setLig(aircoParamsTemp.getLig());
                        PlanoActivity.getDevices().get(i).setMod(aircoParamsTemp.getMod());
                        PlanoActivity.getDevices().get(i).setPow(aircoParamsTemp.getPow());
                        PlanoActivity.getDevices().get(i).setQuiet(aircoParamsTemp.getQuiet());
                        PlanoActivity.getDevices().get(i).setSetTem(aircoParamsTemp.getSetTem());
                        PlanoActivity.getDevices().get(i).setSvSt(aircoParamsTemp.getSvSt());
                        PlanoActivity.getDevices().get(i).setSwhSlp(aircoParamsTemp.getSwhSlp());
                        PlanoActivity.getDevices().get(i).setSwingLfRig(aircoParamsTemp.getSwingLfRig());
                        PlanoActivity.getDevices().get(i).setSwUpDn(aircoParamsTemp.getSwUpDn());
                        PlanoActivity.getDevices().get(i).setTemRec(aircoParamsTemp.getTemRec());
                        PlanoActivity.getDevices().get(i).setTemUn(aircoParamsTemp.getTemUn());
                        PlanoActivity.getDevices().get(i).setTur(aircoParamsTemp.getTur());
                        PlanoActivity.getDevices().get(i).setWdSpd(aircoParamsTemp.getWdSpd());
            ...
            if (RemoteCtrlActivity.getAircoParams().getMac().equals(aircoParamsTemp.getMac())) {
                ...
                for (int i = 0; i < PlanoActivity.getDevices().size(); i++) {
                    ...
                    if (PlanoActivity.getDevices().get(i).getMac().equals(sonoffTemp.getMac())) {

                        PlanoActivity.getDevices().get(i).setPow(sonoffTemp.getPow());
